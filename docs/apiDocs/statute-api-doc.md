...
- Hierarchical node tree with flexible nesting (12 node types)
...
| `node_type` | string | Yes | One of: `act`, `chapter`, `part`, `section`, `subsection`, `article`, `rule`, `schedule`, `regulation`, `clause`, `paragraph`, `item` |
