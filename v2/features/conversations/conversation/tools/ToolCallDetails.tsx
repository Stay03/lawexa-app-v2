...
/**
 * ToolCallDetails (v2 port). Renders a completed tool call's parameters + result
 * summary inside the expanded tool step. Byte-faithful to v1
 * (`components/chat/tool-call-details.tsx`); only the file location changed — every
 * import (cn, lucide, `@/types/chat`, `@/lib/utils/tool-display`) is already in the
 * allowed primitive/util layer.
 */
