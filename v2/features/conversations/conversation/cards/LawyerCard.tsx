        ...
        <CardContent className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0 space-y-1.5">
            <div className="flex items-start justify-between gap-2">
              ...
              {/* Firm logo positioned top-right. Plain <img>: firm logos live on
                  arbitrary external hosts (each lawyer's own firm domain), so
                  next/image would require an open-ended `remotePatterns` allowlist
                  we can't enumerate — the same rationale as the shell Logo.tsx. */}
              {hasFirmLogo && (
