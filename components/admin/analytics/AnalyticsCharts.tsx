 ...
 */
function AnalyticsCharts({ charts }: AnalyticsChartsProps) {
  return (
    <div className="space-y-6">
      {/* Row 1: Conversations over time - full width */}
      <ConversationsOverTimeChart data={charts.conversations_over_time} />

      {/* Row 2: Cost & Tokens (2/3) + Model Usage (1/3) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <CostAndTokensTrendChart data={charts.cost_and_tokens_trend} />
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <MessageRoleDistributionChart data={charts.message_role_distribution} />
