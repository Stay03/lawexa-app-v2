...
interface StatuteV2PageProps {
  params: Promise<{ slug: string }>;
  searchParams: Promise<{ q?: string }>;
}

/**
 * Experimental statute detail page — renders content as a clean legal document.
 */
function StatuteV2Page({ params, searchParams }: StatuteV2PageProps) {
