...
function LawyerConnectAnalyticsContent() {
  ...
  const handlePeriodChange = useCallback(
    (period: AnalyticsPeriod) => {
      if (period !== 'date_range' && period !== 'date') {
        updateParams({ period, date: undefined, start_date: undefined, end_date: undefined });
      } else {
        updateParams({ period });
      }
    },
  ...
  const handleDateChange = useCallback(
    (date: string) => {
      updateParams({ period: 'date', date, start_date: undefined, end_date: undefined });
    },
    [updateParams]
  );
  ...
  const handleCustomRangeChange = useCallback(
    (startDate: string, endDate: string) => {
      updateParams({ period: 'date_range', date: undefined, start_date: startDate, end_date: endDate });
    },
    [updateParams]
  );
