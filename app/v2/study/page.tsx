...
/**
 * v2 `/study` — the Study home tab as a REAL ROUTE.
 *
 ...
 * hydration: a hard load on Study showed the Chat surface and the Chat skeleton
...
export function generateMetadata(): Metadata {
  return {
    title: 'Study',
    description: 'Your channels, conversations and saved research.',
